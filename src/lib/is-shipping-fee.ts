...
export function isShippingFee(name?: string, code?: string, keywords: string[] = []) {
  ...
  const base = ['versand','porto','versandkosten','versandkostenpauschale','lieferkosten','portokosten','paketmarke','shipping','postage', 'fracht', 'speditionskosten', 'transportkosten','dhl','hermes','dpd','gls','ups'];
