...
const prompt = ai.definePrompt({
  ...
  model: 'googleai/gemini-1.5-flash-latest', // Changed model here
...
If specific details (Invoice Number, Supplier, Date) cannot be reliably extracted, use a fallback based on the 'Original Filename' I provide you (you'll need to remove the extension like .pdf from it). For example, if the original filename is "my_scan.pdf", a fallback could be "Processed_my_scan.pdf".
