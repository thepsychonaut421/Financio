...
export function PdfUploadForm({ onFilesSelected, onProcess, isProcessing, selectedFileCount }: PdfUploadFormProps) {
  ...
  return (
    <Card className="w-full max-w-2xl mx-auto shadow-lg">
      <CardHeader>
        ...
        <CardDescription>Select one or more PDF files to extract data from.</CardDescription>
      </CardHeader>
