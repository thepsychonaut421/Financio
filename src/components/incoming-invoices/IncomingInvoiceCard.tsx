...
import { FileText, CalendarDays, Briefcase, MapPin, Clock, Euro, Percent } from 'lucide-react';
...
export function IncomingInvoiceCard({ invoice }: IncomingInvoiceCardProps) {
